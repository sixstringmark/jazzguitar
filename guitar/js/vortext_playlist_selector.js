...
var	mct = [
	/* 000 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_01_part1.mp3', title: 'Show #1 - Part 1', hasNext: true }, 
	/* 001 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_01_part2.mp3', title: 'Show #1 - Part 2', hasNext: true }, 
	/* 002 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_01_part3.mp3', title: 'Show #1 - Part 3' },

	/* 003 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_02_part1.mp3', title: 'Show #2 - Part 1', hasNext: true }, 
	/* 004 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_02_part2.mp3', title: 'Show #2 - Part 2', hasNext: true }, 
	/* 005 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_02_part3.mp3', title: 'Show #2 - Part 3' },  

	/* 006 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_03_part1.mp3', title: 'Show #3 - Part 1', hasNext: true }, 
	/* 007 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_03_part2.mp3', title: 'Show #3 - Part 2', hasNext: true }, 
	/* 008 */ {type: 'local', mp3: 'http://www.mckenzieduo.com/sounds/jazz_guitar_showcase_show_03_part3.mp3', title: 'Show #3 - Part 3' }  
...
function mc_play(idx) {
	...
	console.log('playing number '+idx);
